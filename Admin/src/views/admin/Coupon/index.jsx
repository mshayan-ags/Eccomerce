...
const REQUIRED_FIELDS = ["code", "discountType", "discountValue", "minimumPurchase", "expirationDate", "restrictions"];
      ...
      <div className="col-span-1 h-fit w-full xl:col-span-1 2xl:col-span-2">
        ...
        <div class="grid grid-cols-4 gap-4 my-10 bg-white rounded-[50px] py-20 px-10">
          ...
          <InputField
            ...
            type="datetime-local"
            name="expirationDate"
            value={moment(state?.expirationDate).format("YYYY-MM-DDTHH:mm")}
