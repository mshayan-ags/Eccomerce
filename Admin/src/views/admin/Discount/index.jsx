...
const REQUIRED_FIELDS = ["type", "DiscountType", "value", "startDate", "endDate", "isActive"];
...
const Discount = ({ Token, CheckToken }) => {
  ...
  const GetDiscountInfo = () => {
    if (Token) {
      ...
      CheckToken();
      setTimeout(GetDiscountInfo, 500);
    }
  };
      ...
      <div className="col-span-1 h-fit w-full xl:col-span-1 2xl:col-span-2">
        ...
        <div class="my-10 grid grid-cols-4 gap-4 rounded-[50px] bg-white px-10 py-20">
          ...
          <InputField
            ...
            type="datetime-local"
            name="startDate"
            value={moment(state?.startDate).format("YYYY-MM-DDTHH:mm")}
          ...
          <InputField
            ...
            type="datetime-local"
            name="endDate"
            value={moment(state?.endDate).format("YYYY-MM-DDTHH:mm")}
